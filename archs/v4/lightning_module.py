"""
PyTorch Lightning Module for V4 Prototypical Network (EfficientNet encoder).

Training loop:
- Batch-based prototypical loss over class-balanced batches
- Optional negative contrastive sampling
- Same training behavior as V1, only encoder changed
"""
...
from archs.v4.arch import ProtoNetV4
from utils.distance import Distance
from utils.loss import prototypical_loss, prototypical_loss_filter_negative


class ProtoNetV4LightningModule(L.LightningModule):
    """Prototypical Network Lightning Module with EfficientNet encoder."""
